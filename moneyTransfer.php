    ...
    <div>
        <center>
            <table>
                <thead>
                    <tr>
                        <th class='form-label h2'>Name &nbsp;&nbsp;</th>
                        <th class='form-label h2'>Transfer Money</th>
                    </tr>
                </thead>
                <?php
                    include("databaseCon.php");
                    $con=makeConnection();
                    $us=mysqli_query($con,"select id,name from Users");
                    while($rus=mysqli_fetch_array($us))
                    {
                        echo "<tr>";
                        echo "<td class='form-label h4'>".$rus['name']."</td>";
                        echo "<td><center><a href='transfer.php?id=$rus[0]'><input type='submit' name='transfer' class='btn btn-outline-success' value='Transfer'></center></td></tr>";
                        echo "<tr><td>&nbsp;</td></tr>";
                    }
                ?>
            </table>
